...
%
% Proceses individual SNOw TELemetry (SNOTEL) .csv data into 
% state-level .mat files
%
% Requires:
%   SNOTEL_Inventory_wheaders.mat, created from SNOTEL website:
...
%   including desired variables, year start, year end, network, state, etc.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
